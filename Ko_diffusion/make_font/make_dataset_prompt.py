...
class windows_tkinter:
    ...
    def update_second_class_value_info_WSC(self,scdx):
    ...
    def display_window(self):
        ...
        for scdx in range(32):
            ...
            self.second_class_buttons[scdx] = Button(self.window,image=self.second_class_images[scdx],command=lambda svdx = scdx : self.update_second_class_value_info_WSC(svdx))
